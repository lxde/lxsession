...
public class WebbrowserApp: SimpleAppObject
{
    string webbrowser_command;
    ...
    public override void read_settings()
    {
        webbrowser_command = global_settings.webbrowser_command;

        switch (webbrowser_command)
        {
            default:
                string[] create_command = webbrowser_command.split_set(" ",0);
                this.name = create_command[0];
                this.command = create_command;
                break;
        }
...
public class EmailApp: SimpleAppObject
{
    string email_command;
    ...
    public override void read_settings()
    {
        email_command = global_settings.email_command;

        switch (email_command)
        {
            default:
                string[] create_command = email_command.split_set(" ",0);
                this.name = create_command[0];
                this.command = create_command;
                break;
        }
